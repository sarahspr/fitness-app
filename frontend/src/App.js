    ...
    <Router>
      <div className="main-content">
        ...
        <Route exact path="/" component={Welcome}></Route>
          <Fragment>
            <Header />
            <Route exact path="/bmi-calculator"><BmiCalculator title="BMI Calculator" /></Route>
            <Route exact path="/bmr-calculator"><BmrCalculator title="BMR Calculator" /></Route>
            <Route exact path="/tdee-calculator"><TdeeCalculator title="TDEE Calculator" /></Route>
          </Fragment>
        </Switch>
      </div>
    </Router>
