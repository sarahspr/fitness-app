...
function TdeeCalculator(props) {
	...
	function calculateTdee() {
		...
		setTdeeCalculation(Math.round(tdee));
	...
	return (
		<div className="bmi-calculator">
			...
			<form className="bmi-calculator-form d-flex flex-column align-center">
				...
				>
					<div className="input-container d-flex flex-column align-center mt-1">
				...
				>
					<div className="input-container d-flex align-center mt-1">
						<label className="d-flex align-end">
							<input
								type="text"
								id="metric-weight"
				...
				<div className="activity-multiplier-container input-type d-flex flex-column justify-between align-center w-100 mx-auto mb-1">
					<label for="activity-multiplier" className="label mt-1 mb-1">
						Be Honest with Yourself, How Active Are You Besides Exercise?
					</label>
				...
				<div className="activity-multiplier-container input-type d-flex flex-column justify-between align-center w-100 mx-auto mb-1">
					...
					<div className="select-wrapper">
						<select
							name="exercise-activity-multiplier"
				...
				>
					...
					<span className="bmi-calculation h6">{tdeeCalculation}</span>
				</div>
			</form>
		</div>
	);
